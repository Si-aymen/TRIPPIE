...
private void ajouterabonnement(ActionEvent event) {
    ...
    alert.show();
     try {
            ...
            Parent page1 = FXMLLoader.load(getClass().getResource("/edu/webuild/gui/afficherAbonnement.fxml"));
...
// Update the price text field when the user selects a type
    ...
    @FXML
    private void membership(MouseEvent event) {
         try {
    ...
    @FXML
    private void fidelite(MouseEvent event) {
         try {

            Parent page1 = FXMLLoader.load(getClass().getResource("/edu/webuild/gui/AfficherCarteController.fxml"));
            Scene scene = new Scene(page1);
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            stage.setScene(scene);
            stage.show();
