 ...
 * @author aymen
 */
public class GetPassword3Controller implements Initializable {
    ...
    private void Rechercher(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/edu/webuild/gui/IdentifierCompteLoc.fxml"));
        Parent rat = loader.load();
        IdentifierCompteLocController dc = loader.getController();
