 ...
 * @author aymen
 */
public class CardsLocController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (int i = 0; i < locateurDataList.size(); i++) {
            ...
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/edu/webuild/gui/LocateurCard.fxml"));
                AnchorPane anchorPane = fxmlLoader.load();

                LocateurCardController item2 = fxmlLoader.getController();

                item2.setDataLocateur(locateurDataList.get(i).getId_role().getId_user().getNom(), locateurDataList.get(i).getId_role().getId_user().getPrenom(), locateurDataList.get(i).getNom_agence(), locateurDataList.get(i).getId_role().getLibelle(), locateurDataList.get(i).getImg());
