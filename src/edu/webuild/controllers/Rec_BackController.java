...
import edu.webuild.controller.Item_backController.MyListener;
...
public class Rec_BackController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (recDataList.size() > 0) {
            ...
            myListener = new Item_backController.MyListener() {
    ...
    private void setChosenRec(reclamation r) {
        ...
        System.out.println(Item_backController.r.getType_rec());
        System.out.println(Item_backController.r.getEtat());
