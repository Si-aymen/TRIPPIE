 ...
 * @author guerf
 */
public class Ajouter_backController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\manou\\Desktop\\integration_final\\src\\edu\\webuild\\controllers\\choix.txt"));
